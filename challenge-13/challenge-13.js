...
*/
  ...
  brasil.unshift("Tocantins", "Amazonas", "Manaus");
  console.log(brasil);
...
*/
  ...
  var resultado = brasil.every(estado => estado.length > 7);
  console.log(
    resultado
      ? "Sim, todos os estados tem mais de 7 letras!"
      : "Nem todos os estados tem mais de 7 letras!"
...
*/
  ...
  var cearaAvailable = brasil.includes("Ceará");
  console.log(
    cearaAvailable ? "Ceará está incluído" : "Ceará não foi incluído :("
  );
