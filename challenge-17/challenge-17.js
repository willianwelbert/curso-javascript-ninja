...
*/
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, 'Willian Welbert'));
...
*/
  ...
  console.log(
    text.replace(
      /"O Centauro de Luvas"/ , function(match){
...
*/
  ...
  function getMonthNumber(monthName){
    ...
    return month[ monthName.toLowerCase() ]
  }
...
*/
  console.log("\nReplace de datas:");
  function replaceDate(fullmatch, day, month, year){
