...
*/
  ...
  for (var i = 0; i < splitName.length; i++) {
    console.log(`${splitName[i]} é a ${i + 1}ª letra do meu nome`);
  }
...
*/
  ...
  var myName = "Willian";
  function orkutSpelling(name) {
    var orkutName = [];
    name
      .toLowerCase()
      .split("")
      .map(function(letter, index) {
        orkutName.push(index % 2 === 0 ? letter.toUpperCase() : letter);
      });
    return orkutName.join("");
  }

  console.log(orkutSpelling(myName));
})();
